...
namespace Natia.Common.Services
{
    public static class CommonService
    {
        public static void AddCommonServices(this IServiceCollection service)
        {
            ...
            service.AddScoped<ISmtpClientRepository, SmtpClientRepository>();
            service.AddScoped<ISoundRepository, SoundRepository>();
            service.AddScoped<IUdpComunicationRepository, UdpComunicationRepository>();
            ...
            service.AddScoped<IUdpService, UdpServices>();
